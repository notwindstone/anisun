...
export default function MobileNavbarButton({
    ...
    return (
        <Link
            ...
            prefetch
            className="shrink-0 flex flex-col gap-2 text-xs xxs:text-sm items-center justify-center transition duration-300 hover:brightness-125 dark:hover:brightness-75 w-24"
            style={{
                ...(
                    focused === item.href ? {
